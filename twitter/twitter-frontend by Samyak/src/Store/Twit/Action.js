...
export const getUserTweets = (userId) => async (dispatch) => {
  try {
    ...
    console.log("user all tweets", data);
...
export const findTwitsById = (twitId) => async (dispatch) => {
  try {
    ...
    console.log("find twits by id tweets ", data);
...
export const createTweet = (tweetData) => async (dispatch) => {
  try {
    console.log("data passed for creating tweet: ", tweetData);
    ...
    console.log("catch error in create tweet - ", error);
